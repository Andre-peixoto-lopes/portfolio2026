  ...
  const webProjects: WebProject[] = [
    {
      ...
      description: {
        pt: 'Aplicação web para controle financeiro pessoal com dashboards, receitas, despesas, gastos fixos, compras parceladas e relatórios. Desenvolvida com Node.js, Express e PostgreSQL.',
        en: 'Web application for personal financial control with dashboards, income, expenses, fixed costs, installment purchases and reports. Built with Node.js, Express and PostgreSQL.',
        es: 'Aplicación web para control financiero personal con dashboards, ingresos, gastos, costos fijos, compras en cuotas e informes. Desarrollada con Node.js, Express y PostgreSQL.',
      },
      image: '💰',
      url: 'https://gestao-financeira-andre.vercel.app/',
      tags: ['Node.js', 'Express', 'PostgreSQL', 'JavaScript'],
      github: 'https://github.com/Andre-peixoto-lopes/gestao_financeira',
    },
    {
      id: 'mj-salgados',
      title: {
        pt: 'MJ Salgados - Delivery',
        en: 'MJ Salgados - Delivery',
        es: 'MJ Salgados - Delivery',
      },
      description: {
        pt: 'Landing page e cardápio digital interativo para negócio de salgados artesanais. Sistema de carrinho de compras, cálculo de pedidos e design responsivo.',
        en: 'Landing page and interactive digital menu for artisan snacks business. Shopping cart system, order calculation and responsive design.',
        es: 'Landing page y menú digital interactivo para negocio de bocadillos artesanales. Sistema de carrito de compras, cálculo de pedidos y diseño responsivo.',
      },
      image: '🍴',
      url: 'https://mjsalgados.vercel.app/',
      tags: ['HTML5', 'Tailwind CSS', 'JavaScript'],
      github: 'https://github.com/Andre-peixoto-lopes/MJ_salgados',
    },
    {
      id: 'tempo-web',
      title: {
        pt: 'Informações Climáticas',
        en: 'Weather Info',
        es: 'Información Climática',
      },
      description: {
        pt: 'Aplicação web responsiva para consulta de dados climáticos de cidades. Consome API de clima e apresenta informações de forma clara e intuitiva.',
        en: 'Responsive web application for querying city weather data. Consumes weather API and displays information clearly and intuitively.',
        es: 'Aplicación web responsiva para consulta de datos climáticos de ciudades. Consume API de clima y presenta información de forma clara e intuitiva.',
      },
      image: '🌦️',
      url: 'https://tempo-web-andre-lopes.vercel.app/',
      tags: ['HTML5', 'CSS3', 'JavaScript', 'API'],
      github: 'https://github.com/Andre-peixoto-lopes/Tempo-web',
    },
  ]
